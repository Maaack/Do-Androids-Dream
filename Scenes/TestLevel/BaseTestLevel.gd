...
func _update_scores() -> void:
	...
	if good_word_counter == null or bad_word_counter == null:
		return
...
func _on_PoisonSheepButton_pressed():
	...
	add_event("The robot sheep %s rapidly disassembled." % random_sheep)
...
func _on_BuildSheepButton_pressed():
	...
	add_event("You assembled a new robot sheep and called it %s." % random_sheep)
	_update_counters()
